...
function preload()
{
  ...
  //allStar= loadAnimation("stars.png")
...
function setup() 
{
  ...
  star2 = createSprite(100,280,20,20);
  ...
  bunny = createSprite(220,height-80,100,100);
  bunny.scale = 0.2;
...
function draw() 
{
  ...
  //if(collide(fruit,star,40)===true && collide(fruit,star2,40)===true){
  //  star.visible = false
  //  star2.visible = false;
  // star_display.addAnimation("allStars");
  //}
}
